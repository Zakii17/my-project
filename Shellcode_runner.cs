...
namespace ConsoleApp1
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            int size = buf.Length; // Get the size of the shellcode
